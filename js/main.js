...
if (document.querySelectorAll('.content-404').length > 0) {
	const headerHeight = document.querySelector('header').offsetHeight
	const block404 = document.querySelector('.content-404')
	block404.style.marginTop= headerHeight + 'px'
}


const modal = document.querySelector('.modal')
const btnOpenModal = document.querySelectorAll('.modal__open')
const btnModalClose = modal.querySelectorAll('.modal__close')
